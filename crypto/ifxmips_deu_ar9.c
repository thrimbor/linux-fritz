...
struct deu_proc ifx_deu_algo[] = {
    {
        .name = "aes",
	.deu_status = 1,
        .toggle_algo = ifx_aes_toggle_algo,
        .get_deu_algo_state = read_aes_algo_status 
    },{
        .name = "des",
	.deu_status = 1,
        .toggle_algo = ifx_des_toggle_algo,
	.get_deu_algo_state = read_des_algo_status
    },{
        .name = "md5",
	.deu_status = 1,
        .toggle_algo = ifx_md5_toggle_algo,
	.get_deu_algo_state = read_md5_algo_status
    },{
        .name = "sha1",
	.deu_status = 1,
        .toggle_algo = ifx_sha1_toggle_algo,
	.get_deu_algo_state = read_sha1_algo_status
    },{
        .name = "md5_hmac",
	.deu_status = 1,
        .toggle_algo = ifx_md5_hmac_toggle_algo,
	.get_deu_algo_state = read_md5_hmac_algo_status
    },{
        .name = "sha1_hmac",
	.deu_status = 1,
        .toggle_algo = ifx_sha1_hmac_toggle_algo,
	.get_deu_algo_state = read_sha1_hmac_algo_status
    },{
        .name = "arc4",
	.deu_status = 1,
        .toggle_algo = ifx_arc4_toggle_algo,
