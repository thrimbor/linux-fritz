...
static int __init tcrypt_mod_init(void)
{
	...
	printk(KERN_INFO "Starting Lantiq DEU Crypto TESTS . . . . . . .\n");
...
#if defined(CONFIG_CRYPTO_DEV_DEU)
#if defined(CONFIG_CRYPTO_DEV_MD5) || defined (CONFIG_CRYPTO_MD5)
...
#endif
#if defined(CONFIG_CRYPTO_DEV_SHA1) || defined (CONFIG_CRYPTO_SHA1)
...
#endif
#if defined(CONFIG_CRYPTO_DEV_ARC4) || defined (CONFIG_CRYPTO_ARC4)
	mode = 16;
	err = do_test(mode);
