...
#define ATM_DEL_INTERFACE _IOW('a',ATMIOC_SPECIAL+6,atm_backend_t) //FUSIV
                                        /* use backend to delete new if */
#endif
...
static inline int atm_may_send(struct atm_vcc *vcc, int size)
{
