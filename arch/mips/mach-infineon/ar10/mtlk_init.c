...
//#define MTLK_MEM_BAR0_START (0x01E00000)
//#define MTLK_MEM_BAR0_END   (0x01EFFFFF)
#define MTLK_MEM_BAR0_START (0x03E00000)
#define MTLK_MEM_BAR0_END   (0x03EFFFFF)
...
static struct resource mtlk_ahb_resources[] = {
  [0] = {
    ...
    .start = MTLK_MEM_BAR0_START,
    .end   = MTLK_MEM_BAR0_END,
