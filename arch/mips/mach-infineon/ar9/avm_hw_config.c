...
#include "avm_hw_config_hw172.h"
#include "avm_hw_config_hw179.h"
#include "avm_hw_config_hw188.h"
#include "avm_hw_config_hw189.h"
...
struct _avm_hw_config_table avm_hw_config_tables[] = {
    { .hwrev = 161, .table = avm_hardware_config_hw172 }, /*--- FRITZ!Box Bene ---*/
    { .hwrev = 172, .table = avm_hardware_config_hw172 }, /*--- FRITZ!Box Fon WLAN 7320 ---*/
    { .hwrev = 178, .table = avm_hardware_config_hw179 }, /*--- FRITZ!Box Fon WLAN 7313 (eingestellt)---*/
    { .hwrev = 179, .table = avm_hardware_config_hw179 }, /*--- FRITZ!Box Fon WLAN 7330 ---*/
    { .hwrev = 188, .table = avm_hardware_config_hw188 }, /*--- FRITZ!Box Fon WLAN 7330 SL ---*/
    { .hwrev = 189, .table = avm_hardware_config_hw189 }, /*--- FRITZ!Box Fon WLAN 7312 ---*/
};
...
#define GPIO_BOARD_CONFIG_SIZE 50  /*--- Last is reserved for marking end of config ---*/
