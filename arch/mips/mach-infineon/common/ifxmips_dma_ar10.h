...
static char dma_device_name[5][20] = {{"PPE"},{"DEU" },{"USIF" },{"HSNAND"},{"PCM"}};
static _dma_chan_map ifx_default_dma_map[24] = {
    ...
    {4, "PCM",      IFX_DMA_RX_CH,  0,  IFX_DMA_CH16_INT,   0},
    {4, "PCM",      IFX_DMA_TX_CH,  0,  IFX_DMA_CH17_INT,   0},
    {4, "PCM",      IFX_DMA_RX_CH,  0,  IFX_DMA_CH18_INT,   0},
    {4, "PCM",      IFX_DMA_TX_CH,  0,  IFX_DMA_CH19_INT,   0},
