...
#include "avm_hw_config_hw175.h"
#include "avm_hw_config_hw177.h"
#include "avm_hw_config_hw181.h"
#include "avm_hw_config_hw183.h"
#include "avm_hw_config_hw185.h"
#include "avm_hw_config_hw193.h"
#include "avm_hw_config_hw202.h"
#include "avm_hw_config_hw203.h"
...
struct _avm_hw_config_table avm_hw_config_tables[] = {
    { .hwrev = 175, .hwsubrev = 1, .table = avm_hardware_config_hw175_subrev_1 }, /*--- FRITZ!Box 3370 HW-Sub-Rev 1 ---*/
    { .hwrev = 175,                .table = avm_hardware_config_hw175 },          /*--- FRITZ!Box 3370 ---*/
    { .hwrev = 177, .hwsubrev = 1, .table = avm_hardware_config_hw177_subrev_1 }, /*--- FRITZ!Box 6840 LTE HW-Sub-Rev 1 ---*/
    { .hwrev = 177,                .table = avm_hardware_config_hw177 },          /*--- FRITZ!Box 6840 LTE ---*/
    { .hwrev = 181,                .table = avm_hardware_config_hw181 },          /*--- FRITZ!Box Fon 7360 SL ---*/
    { .hwrev = 183,                .table = avm_hardware_config_hw183 },          /*--- FRITZ!Box Fon 7360 ---*/
    { .hwrev = 185,                .table = avm_hardware_config_hw185 },          /*--- FRITZ!Box Fon 7391 ---*/
    { .hwrev = 193,                .table = avm_hardware_config_hw193 },          /*--- FRITZ!Box Fon 3390 ---*/
    { .hwrev = 196,                .table = avm_hardware_config_hw183 },          /*--- FRITZ!Box Fon 7360v2 ---*/
    { .hwrev = 202,                .table = avm_hardware_config_hw202 },          /*--- FRITZ!Box Fon 7362 ---*/
    { .hwrev = 203,                .table = avm_hardware_config_hw203 },          /*--- FRITZ!Box Fon 7362 SL (identische GPIOs zur 7362) ---*/
};
