...
#else /*--- #if defined(CONFIG_VLYNQ_SUPPORT) ---*/
#define UR8_INT_END_VIRTUAL            UR8_INT_END_SECONDARY
#endif /*--- #if defined(CONFIG_VLYNQ_SUPPORT) ---*/

#if defined(CONFIG_PCI )
#define UR8_INT_PCI_BEGIN		( UR8_INT_END_VIRTUAL )
#define UR8_INT_PCI_END		    ( UR8_INT_PCI_BEGIN + 4)
...
/*------------------------------------------------------------------------------------------*\
\*------------------------------------------------------------------------------------------*/
#define UR8_C55_INTR_SET                   ((unsigned int *)(KERNEL_ADDR(0x08611A2C)))
#define UR8_C55_INTR_CLEAR                 ((unsigned int *)(KERNEL_ADDR(0x08611A30)))
#define UR8_C55_NMI_REG                    ((unsigned int *)(KERNEL_ADDR(0x08611A00)))
