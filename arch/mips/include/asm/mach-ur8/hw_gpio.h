...
#define _GPIO_BIT_MII2RD1           43
#define _GPIO_BIT_MII2RD0           42
#define _GPIO_BIT_MII2TD1           41
#define _GPIO_BIT_MII2TD0           40
#define _GPIO_BIT_PREQ2             39 
#define _GPIO_BIT_PREQ1             38
#define _GPIO_BIT_EINT              37
#define _GPIO_BIT_MII2RER           36
#define _GPIO_BIT_MII2RDV           35
#define _GPIO_BIT_MII2CRS           34 
#define _GPIO_BIT_MII2COL           33 
#define _GPIO_BIT_MII2TCLK          32
#define _GPIO_BIT_MII2RCLK          31
#define _GPIO_BIT_MII2RD3           30
#define _GPIO_BIT_MII2RD2           29
#define _GPIO_BIT_VLRXD1            28
#define _GPIO_BIT_VLRXD0            27
#define _GPIO_BIT_PINTB  		    26
#define _GPIO_BIT_PGNT2            	25
#define _GPIO_BIT_PGNT1            	24
#define _GPIO_BIT_CE3              	23
#define _GPIO_BIT_MII2TEN          	22
#define _GPIO_BIT_MII2TD3         	21
#define _GPIO_BIT_MII2TD2         	20
#define _GPIO_BIT_UARTB_RD         	19
#define _GPIO_BIT_UARTB_TD         	18
#define _GPIO_BIT_UARTA_CTS        	17
#define _GPIO_BIT_UARTA_TD         	16
#define _GPIO_BIT_UARTA_RD       	15
#define _GPIO_BIT_SPI_RX           	14
#define _GPIO_BIT_SPI_TX           	13
#define _GPIO_BIT_SPI_CLK          	12
#define _GPIO_BIT_SPI_S1           	11
#define _GPIO_BIT_SPI_S0           	10
#define _GPIO_BIT_UARTA_RTS        	 9
#define _GPIO_BIT_UARTC_RD           8
#define _GPIO_BIT_UARTC_TD         	 7
#define _GPIO_BIT_TDMTD            	 6
#define _GPIO_BIT_TDMFS           	 5
#define _GPIO_BIT_TDMCLK           	 4
#define _GPIO_BIT_TDMRD            	 3
#define _GPIO_BIT_JEMU1            	 2
#define _GPIO_BIT_PINTC            	 1
#define _GPIO_BIT_DRVVBUS          	 0
...
union _hw_gpio_bits {
    struct __hw_gpio_bits {
        ...
        /*--- Bit 18 ----*/ unsigned int uart1_td : 1;
        /*--- Bit 19 ----*/ unsigned int uart1_rd : 1;
...
static inline int gpio_get_value(unsigned gpio)
{
	void __iomem *gpio_in =
		(void __iomem *)KSEG1ADDR(UR8_GPIO_BASE + GPIO_R_IN);
...
static inline void gpio_set_value(unsigned gpio, int value)
{
	void __iomem *gpio_out =
		(void __iomem *)KSEG1ADDR(UR8_GPIO_BASE + GPIO_R_OUT);
	unsigned tmp;
...
static inline int gpio_direction_input(unsigned gpio)
{
	void __iomem *gpio_dir =
		(void __iomem *)KSEG1ADDR(UR8_GPIO_BASE + GPIO_R_DIR);
...
static inline int gpio_to_irq(unsigned gpio __attribute__ ((unused)))
{
	return -EINVAL;
}

static inline int irq_to_gpio(unsigned irq __attribute__ ((unused)))
{
	return -EINVAL;
}

/* Board specific GPIO functions */
static inline int ur8_gpio_enable(unsigned gpio)
{
	void __iomem *gpio_en =
		(void __iomem *)KSEG1ADDR(UR8_GPIO_BASE + GPIO_R_EN );
...
static inline int ur8_gpio_disable(unsigned gpio)
{
	void __iomem *gpio_en =
		(void __iomem *)KSEG1ADDR(UR8_GPIO_BASE + GPIO_R_EN );
