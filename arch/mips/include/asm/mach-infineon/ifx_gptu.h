...
#define TIMER_FLAG_NO_HANDLE            0x0000
    ...
    #define TIMER_FLAG_YIELD_MODE   	 0x0400
    #define TIMER_FLAG_MASK_HANDLE(x)	(x & 0x0700)
...
#define IFX_GPTU_VER_MAJOR              2
#define IFX_GPTU_VER_MID                0
#define IFX_GPTU_VER_MINOR              1
