...
enum {
    IFX_RCU_DOMAIN_HRST  = 0,   //  HRST output              (0: RD0)
    IFX_RCU_DOMAIN_CPU0,        //  Main CPU                 (1: RD1)
    IFX_RCU_DOMAIN_FPI,         //  FPI bus                  (2: RD2)
    IFX_RCU_DOMAIN_DLLCORE,     //  HN DLL Core              (3: RD3)
    IFX_RCU_DOMAIN_I2C,         //  I2C                      (4: RD4)
    IFX_RCU_DOMAIN_AHB,         //  AHB bus                  (5: RD6)
    IFX_RCU_DOMAIN_BULKSRAM,    //  BULK SRAM                (6: RD7)
    IFX_RCU_DOMAIN_I2S,         //  I2S module               (7: RD8)
    IFX_RCU_DOMAIN_DMA,         //  DMA module               (8: RD9)
    IFX_RCU_DOMAIN_SDIO,        //  SDIO module              (9: RD10)
    IFX_RCU_DOMAIN_PHYCORE,     //  PHY CORE                 (10:RD11)
    IFX_RCU_DOMAIN_PCIEPHY,     //  PCIE PHY                 (12:RD12)
    IFX_RCU_DOMAIN_MC,          //  Memory Controller module (13:RD14)
    IFX_RCU_DOMAIN_HSNAND,      //  HSNAND                   (14:RD16)
    IFX_RCU_DOMAIN_TDM,         //  TDM interface (Voice)    (15:RD19)
    IFX_RCU_DOMAIN_SW,          //  ETHERNET SWITCH          (16:RD21)
    IFX_RCU_DOMAIN_PCIE,        //  PCIE PART                (17:RD22)
    IFX_RCU_DOMAIN_AHBDLL,      //  AHB DLL                  (18:RD23)
    IFX_RCU_DOMAIN_GPHY0,       //  GPHY0                    (19: RD31)
