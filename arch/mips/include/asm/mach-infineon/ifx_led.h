...
/*
 * Macros for dual color LED
 */
#define IFX_LED_DUAL_MAKE_PHYS_ID(phys_id_led1, phys_id_led2) (((phys_id_led2) << 16) | (phys_id_led1))
#define IFX_LED_DUAL_GET_PHYS_ID_LED1(phys_id) ((phys_id) & 0xffff)
#define IFX_LED_DUAL_GET_PHYS_ID_LED2(phys_id) (((phys_id) >> 16) & 0xffff)
...
struct ifx_led_device {
    ...
    unsigned int            color;              /*!< color of the LED */
/*!
...
#define IFX_LED_DEVICE_FLAG_DUAL_LED    (1 << 29)
