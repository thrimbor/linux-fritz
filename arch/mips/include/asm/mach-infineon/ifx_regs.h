...
//#define IFX_REG32(addr)                    *((volatile unsigned int *)(addr))
...
#define IFX_FAMILY_AR10                 5
#define IFX_FAMILY_xRX300               IFX_FAMILY_AR10
...
#define IFX_FAMILY_VR9_A2x              2
#define IFX_FAMILY_xRX200_A2x           IFX_FAMILY_VR9_A2x
#define IFX_FAMILY_AR10_A1x             1
#define IFX_FAMILY_xRX300_A1x           IFX_FAMILY_AR10_A1x
...
#define IFX_PARTNUM_ARX361              0x0003  //  1x1 Router
#define IFX_PARTNUM_ARX362              0x0004  //  2x2 Router
#define IFX_PARTNUM_ARX363              0x0005  //  3x3 Router
#define IFX_PARTNUM_ARX381              0x0006  //  1x1 Gateway
#define IFX_PARTNUM_ARX382              0x0007  //  2x2 Gateway
#define IFX_PARTNUM_ARX383              0x0008  //  3x3 Gateway
#define IFX_PARTNUM_GRX388              0x0009  //  3x3 Ethernet Router/Gateway
#define IFX_PARTNUM_ARX368              0x000A  //  3x3 High-end Router
#define IFX_PARTNUM_ARX388              0x000B  //  3x3 High-end Gateway
    unsigned int        part_number;
    unsigned int        chip_version;
    unsigned int        manufacturer_id;
} ifx_chipid_t;
static inline unsigned int ifx_get_chipid(ifx_chipid_t *p_chipid)
{
    unsigned int chipid;
    ...
    switch ( p_chipid->part_number ) {
        ...
        case IFX_PARTNUM_GRX288_A2x:
            ...
            break;
        case IFX_PARTNUM_ARX361:
        case IFX_PARTNUM_ARX362:
        case IFX_PARTNUM_ARX363:
        case IFX_PARTNUM_ARX381:
        case IFX_PARTNUM_ARX382:
        case IFX_PARTNUM_ARX383:
        case IFX_PARTNUM_GRX388:
        case IFX_PARTNUM_ARX368:
//        case IFX_PARTNUM_ARX388:  //  conflict with VR9
            p_chipid->family_id  = IFX_FAMILY_xRX300;
            p_chipid->family_ver = IFX_FAMILY_xRX300_A1x;
            break;
        default:
