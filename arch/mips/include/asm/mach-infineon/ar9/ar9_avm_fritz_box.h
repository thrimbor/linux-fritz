...
#ifndef AR9_AVM_FRITZ_BOX_H
#define AR9_AVM_FRITZ_BOX_H
...
#define IFX_MTD_JFFS2_MAX_SIZE  16
  ...
  #define IFX_GPIO_USB_VBUS1              IFX_GPIO_PIN_ID(50/16, 50%16)
  #define IFX_GPIO_USB_VBUS2              IFX_GPIO_PIN_ID(51/16, 51%16)
#endif

#endif  /* AR9_AVM_FRITZ_BOX_H */
