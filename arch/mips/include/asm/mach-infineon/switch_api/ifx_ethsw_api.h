...
#ifdef CONFIG_AR10
#define IFX_ETHSW_DEV_MAX               4
#endif /*--- #ifdef CONFIG_AR10 ---*/

#define SWITCH_API_MODULE_NAME          "IFX ETHSW SWITCH API"
#define SWITCH_API_DRIVER_VERSION       "1.1.8.5"
...
union ifx_sw_param
{
  ...
  /* Debug Features */
#if defined(CONFIG_AR9) || defined(CONFIG_DANUBE) || defined(CONFIG_AMAZON_SE)
    IFX_PSB6970_register_t					register_access;
#elif ( defined(CONFIG_VR9)  || defined(CONFIG_AR10) || defined(CONFIG_HN1) )
