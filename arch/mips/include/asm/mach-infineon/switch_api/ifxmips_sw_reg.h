...
#define VR9_INT_BASE_ADDR                 (0xBF107000)
#define MPS_CHIPID								                        (VR9_INT_BASE_ADDR + 0x344)
...
#define GFS_ADD1                                                      (VR9_RCU_BASE_ADDR + 0x58)
#define GFS_ADD2                                                      (VR9_RCU_BASE_ADDR + 0xAC)
#endif
