...
enum {
    ...
    IFX_GPIO_MODULE_PIGLET,
    IFX_GPIO_MODULE_PCMLINK,
    IFX_GPIO_MODULE_TDMCHECK,
    IFX_GPIO_MODULE_SYSTEM,
    IFX_GPIO_MODULE_EXTPHY_INT,
    IFX_GPIO_MODULE_EXTPHY_MDIO,
    IFX_GPIO_MODULE_EXTPHY_RESET,
    IFX_GPIO_MODULE_EXTPHY_25MHZ_CLOCK,
    IFX_GPIO_MODULE_FPGA,
    IFX_GPIO_MODULE_WLAN_OFFLOAD_WASP_RESET,
