...
#define ATH_I2C_BASE            ATH_APB_BASE+0x00018000
...
#define ATH_DDR_WB_FLUSH_SRC2		    ATH_DDR_CTL_BASE+0xb4	/*--- checksum engine ---*/
...
#define ATH_DDR_MON_ALL_GNT		    ATH_DDR_CTL_BASE+0xec       /*--- Total Number of Grants - All clients, all banks ---*/
#define ATH_DDR_MON_ALL_REQ_DUR_L	ATH_DDR_CTL_BASE+0xf0       /*--- Total Request Assertion Duration(Low/High) - How long the request has been asserted. ---*/
#define ATH_DDR_MON_ALL_REQ_DUR_H	ATH_DDR_CTL_BASE+0xf4
#define ATH_DDR_MON_GNT			    ATH_DDR_CTL_BASE+0xf8       /*--- All Bank Total Number of Grants for the Selected Client ---*/
#define ATH_DDR_MON_DUR_GNT_L		ATH_DDR_CTL_BASE+0xfc       /*--- All Bank Total Number of Grants for the Selected Client Request assertion duration for a seleceted client. ---*/
#define ATH_DDR_MON_DUR_GNT_H		ATH_DDR_CTL_BASE+0x100
#define ATH_DDR_MON_MAX_LATENCY		ATH_DDR_CTL_BASE+0x104      /*--- Maximum Grant Latency for client C ---*/
 ...
 * i2c
\*------------------------------------------------------------------------------------------*/
#define ATH_I2C_OFF_I2CON                       (ATH_I2C_BASE + 0x00)       /*I2C Control Register*/
#define ATH_I2C_OFF_TAR                         (ATH_I2C_BASE + 0x04)       /*I2C Target Address Register*/
#define ATH_I2C_OFF_SAR                         (ATH_I2C_BASE + 0x08)       /*I2C Slave Address Register*/
#define ATH_I2C_OFF_HS_MADDR                    (ATH_I2C_BASE + 0x0C)
#define ATH_I2C_OFF_DATA_CMD                    (ATH_I2C_BASE + 0x10)
#define ATH_I2C_OFF_SS_SCL_HCNT                 (ATH_I2C_BASE + 0x14)
#define ATH_I2C_OFF_SS_SCL_LCNT                 (ATH_I2C_BASE + 0x18)
#define ATH_I2C_OFF_FS_SCL_HCNT                 (ATH_I2C_BASE + 0x1C)
#define ATH_I2C_OFF_FS_SCL_LCNT                 (ATH_I2C_BASE + 0x20)
#define ATH_I2C_OFF_HS_SCL_HCNT                 (ATH_I2C_BASE + 0x24)
#define ATH_I2C_OFF_HS_SCL_LCNT                 (ATH_I2C_BASE + 0x28)
#define ATH_I2C_OFF_RAW_INTR_STAT               (ATH_I2C_BASE + 0x2C)
#define ATH_I2C_OFF_INTR_MASK                   (ATH_I2C_BASE + 0x30)
#define ATH_I2C_OFF_INTR_STAT                   (ATH_I2C_BASE + 0x34)
#define ATH_I2C_OFF_RX_TL                       (ATH_I2C_BASE + 0x38)
#define ATH_I2C_OFF_TX_TL                       (ATH_I2C_BASE + 0x3c)
#define ATH_I2C_OFF_CLR_INTR                    (ATH_I2C_BASE + 0x40)
#define ATH_I2C_OFF_CLR_RX_UNDER                (ATH_I2C_BASE + 0x44)
#define ATH_I2C_OFF_CLR_RX_OVER                 (ATH_I2C_BASE + 0x48)
#define ATH_I2C_OFF_CLR_TX_OVER                 (ATH_I2C_BASE + 0x4c)
#define ATH_I2C_OFF_CLR_RD_REQ                  (ATH_I2C_BASE + 0x50)
#define ATH_I2C_OFF_CLR_TX_ABRT                 (ATH_I2C_BASE + 0x54)
#define ATH_I2C_OFF_CLR_RX_DONE                 (ATH_I2C_BASE + 0x58)
#define ATH_I2C_OFF_CLR_ACTIVITY                (ATH_I2C_BASE + 0x5C)
#define ATH_I2C_CLR_STOP_DET                    (ATH_I2C_BASE + 0x60)
#define ATH_I2C_CLR_START_DET                   (ATH_I2C_BASE + 0x64)
#define ATH_I2C_CLR_GEN_CALL                    (ATH_I2C_BASE + 0x68)
#define ATH_I2C_ENABLE                          (ATH_I2C_BASE + 0x6C)
#define ATH_I2C_STATUS                          (ATH_I2C_BASE + 0x70)
#define ATH_I2C_TXFLR                           (ATH_I2C_BASE + 0x74)
#define ATH_I2C_RXFLR                           (ATH_I2C_BASE + 0x78)
#define ATH_I2C_SRESET                          (ATH_I2C_BASE + 0x7C)
#define ATH_I2C_TX_ABRT_SOURCE                  (ATH_I2C_BASE + 0x80)
...
#define ATH_PCIE_PLL_CONFIG             ATH_PLL_BASE+0xc
#define ATH_PCIE_DITHER_DIV_MAX         ATH_PLL_BASE+0x10
#define ATH_PCIE_DITHER_DIV_MIN         ATH_PLL_BASE+0x14

#define ATH_SWITCH_CLK_CONFIG		    ATH_PLL_BASE+0x20
#define ATH_ETH_XMII_CONFIG		        ATH_PLL_BASE+0x28
#define ATH_AUDIO_PLL_CONFIG		    ATH_PLL_BASE+0x2c
...
#define ATH_PCI_WINDOW0_OFFSET		ATH_APB_BASE+0x7c
#define ATH_PCI_WINDOW1_OFFSET		ATH_APB_BASE+0x80
#define ATH_PCI_WINDOW2_OFFSET		ATH_APB_BASE+0x84
#define ATH_PCI_WINDOW3_OFFSET		ATH_APB_BASE+0x88
#define ATH_PCI_WINDOW4_OFFSET		ATH_APB_BASE+0x8c
#define ATH_PCI_WINDOW5_OFFSET		ATH_APB_BASE+0x90
#define ATH_PCI_WINDOW6_OFFSET		ATH_APB_BASE+0x94
#define ATH_PCI_WINDOW7_OFFSET		ATH_APB_BASE+0x98
...
#define ATH_MISC_IRQ_COUNT		32
#define ATH_GPIO_IRQ_BASE		(ATH_MISC_IRQ_BASE + ATH_MISC_IRQ_COUNT)    /*--- 0x30 ---*/
#define ATH_GPIO_IRQ_COUNT		32
#define ATH_PCI_IRQ_BASE		(ATH_GPIO_IRQ_BASE + ATH_GPIO_IRQ_COUNT)    /*--- 0x50 ---*/
...
#define GPIO_OUT_BOOT_RXT_MDI           1     /*--- Boot MDIO MDI signal (MDIO slave for boot up) ---*/
...
#define GPIO_OUT_I2C_DATA               6
#define GPIO_OUT_I2C_CLK                7
#define GPIO_OUT_SPI_CLK                8     /*--- SPI Clock ---*/
#define GPIO_OUT_SPI_CS_0               9     /*--- SPI chip select 0 ---*/
#define GPIO_OUT_SPI_CS_1               10    /*--- SPI chip select 1 ---*/
#define GPIO_OUT_SPI_CS_2               11    /*--- SPI chip select 2 ---*/
#define GPIO_OUT_SPI_MOSI               12    /*--- SPI data output ---*/
...
#define GPIO_OUT_UART1_TD               18    /*--- High-speed UART1 transmit data ---*/
#define GPIO_OUT_UART1_RTS              19    /*--- High-speed UART1 request to send ---*/
#define GPIO_OUT_UART1_RD               20    /*--- High-speed UART1 receive data ---*/
#define GPIO_OUT_UART1_CTS              21    /*--- High-speed UART1 clear to send ---*/
#define GPIO_OUT_UART0_SOUT             22    /*--- Low-speed UART0 transmit data ---*/
#define GPIO_OUT_SPDIF_OUT_23           23    /*--- SPDIF data output ---*/
#define GPIO_OUT_LED_SGMII_SPEED0       24
#define GPIO_OUT_LED_SGMII_SPEED1       25
#define GPIO_OUT_LED_SGMII_DUPLEX       26
#define GPIO_OUT_LED_SGMII_LINK         27
#define GPIO_OUT_LED_SGMII_SPEED0_INV   28
#define GPIO_OUT_LED_SGMII_SPEED1_INV   29
#define GPIO_OUT_LED_SGMII_DUPLEX_INV   30
#define GPIO_OUT_LED_SGMII_LINK_INV     31
#define GPIO_OUT_GE1_MII_MDO            32
#define GPIO_OUT_GE1_MII_MDC            33

#define GPIO_OUT_SWCOM2                 38
#define GPIO_OUT_SWCOM3                 39
#define GPIO_OUT_MAC_GPIO_BIT2          40
#define GPIO_OUT_MAC_GPIO_BIT3          41
#define GPIO_OUT_ATT_LED                42    /*--- External LNA control for chain 0 ---*/
#define GPIO_OUT_PWR_LED                43    /*--- External LNA control for chain 1 ---*/
#define GPIO_OUT_TX_FRAME               44    /*--- Active transmit indicator ---*/
#define GPIO_OUT_RX_CLEAR_EXTERNAL      45    /*--- Indicates no active transmit or receive in progress ---*/
#define GPIO_OUT_LED_NETWORK_EN         46    
#define GPIO_OUT_LED_POWER_EN           47    

#define GPIO_WMAC_GLUE_WOW              68 

#define GPIO_OUT_RX_CLEAR_EXTENSION     70    /*--- Indicates no active transmit or receive in progress on secondary channel ---*/

#define GPIO_OUT_NAND_CS                73    /*--- NAND Flash chip select ---*/
#define GPIO_OUT_USB_SUSPEND            74    /*--- USB suspend ---*/
#define GPIO_OUT_ETH_TX_ERR             75    /*--- MII transmit error ---*/               
#define GPIO_OUT_DDR_DQ_OE              76    /*--- DDR data output enable ---*/
#define GPIO_CLKREQ_N_EP                77    /*--- Clock request endpoint ---*/
#define GPIO_CLKREQ_N_RC                78    /*--- Clock request root complex ---*/
#define GPIO_OUT_CLK_OBS0               79    /*--- Observation of 25 MHz GMAC0 MII clock ---*/
#define GPIO_OUT_CLK_OBS1               80    /*--- Observation of PCIE_RC_CLK ---*/
#define GPIO_OUT_CLK_OBS2               81    /*--- Observation of PCIE_EP_CLK ---*/
#define GPIO_OUT_CLK_OBS3               82    /*--- Observation of GMAC1_TX_CLK ---*/
#define GPIO_OUT_CLK_OBS4               83    /*--- Observation of AHB_CLK/2 ---*/
#define GPIO_OUT_CLK_OBS5               84    /*--- Observation of AHB_CLK/4 ---*/
...
#define GPIO_IN_SLIC_EXTMCLK  (GPIO_IN_ENABLE_REGNUM(2) | GPIO_IN_ENABLE_SHIFT(24))  /*---  ---*/
#define GPIO_IN_MII_EXT_MDO   (GPIO_IN_ENABLE_REGNUM(3) | GPIO_IN_ENABLE_SHIFT(0))   /*--- External MDIO interface for boot up, management data clock ---*/
#define GPIO_IN_MII_EXT_MDC   (GPIO_IN_ENABLE_REGNUM(3) | GPIO_IN_ENABLE_SHIFT(8))   /*--- External MDIO interface for boot up, management data I/O ---*/
#define GPIO_IN_MII_GE1_MDI   (GPIO_IN_ENABLE_REGNUM(3) | GPIO_IN_ENABLE_SHIFT(16))  /*--- MII GE1 MDIO input ---*/
...
#define GPIO_IN_I2C_CLK       (GPIO_IN_ENABLE_REGNUM(4) | GPIO_IN_ENABLE_SHIFT(16))  /*--- I2C clock ---*/
#define GPIO_IN_I2C_DATA      (GPIO_IN_ENABLE_REGNUM(4) | GPIO_IN_ENABLE_SHIFT(24))  /*--- I2C data ---*/

/*--- #define GPIO_IN_UART1_TD      (GPIO_IN_ENABLE_REGNUM(9) | GPIO_IN_ENABLE_SHIFT(0)) ---*/  /*--- High-speed UART1 transmit data ---*/
#define GPIO_IN_UART1_RTS     (GPIO_IN_ENABLE_REGNUM(9) | GPIO_IN_ENABLE_SHIFT(8))  /*--- High-speed UART1 clear to send ---*/
...
#define ATH_SPARE_STICKY		    ATH_RESET_BASE+0xb8
...
#define is_sco()	        (1)
#define is_drqfn()      	(!(ath_reg_rd(ATH_REV_ID) & 0x1000))
#define is_qca955x()	    (1)

#define is_qca9556()        (ath_reg_rd(ATH_REV_ID) == 0x0130)
#define is_qca9558()        (ath_reg_rd(ATH_REV_ID) == 0x1130)
...
#define ATH_MBOX_RX_DMA_COMPLETE(dummy)         (1 << 10)
#define ATH_MBOX_TX_DMA_EOM_COMPLETE            (1 << 8)
#define ATH_MBOX_TX_DMA_COMPLETE(dummy)         (1 << 6)
...
#define ATH_PCI_LCL_RESET                                           PCIE_RESET_ADDRESS
...
#elif defined(CONFIG_ATH_HAS_PCI_RC2) && defined(CONFIG_ATH_EMULATION)
#error "CONFIG_ATH_HAS_PCI_RC2 not implemented"
	/*
