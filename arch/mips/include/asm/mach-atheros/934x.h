...
#define GPIO_OUT_ATT_LED             46    /*--- External LNA control for chain 0 ---*/
#define GPIO_OUT_PWR_LED             47    /*--- External LNA control for chain 1 ---*/
...
#define ATH_HS_UART1_TD			0x4f
#define ATH_HS_UART1_RTS		0x50
...
#define	ATH_SRAM_BASE_CACHED	0x9d000000
#define	ATH_NMI_VECTOR_ADDR	0x80000380
#define	ATH_SRAM_SIZE	(1 << 15)


#define	ATH_NMI_TRIGGER_USEC		(ATH_NMI_TRIGGER / 40)       /*--- Komaptibiltaet ---*/
