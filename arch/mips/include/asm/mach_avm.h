...
#define avm_set_clock_notify        ur8_set_clock_notify
...
/*--- #define avm_gpio_init        arx188_gpio_init ---*/
/*--- #define avm_gpio_ctrl        arx188_gpio_ctrl ---*/
/*--- #define avm_gpio_out_bit     arx188_gpio_out_bit ---*/
/*--- #define avm_gpio_in_bit      arx188_gpio_in_bit ---*/
...
\*------------------------------------------------------------------------------------------*/
#if defined(CONFIG_MACH_AR7240) || defined(CONFIG_MACH_AR724x) || defined(CONFIG_MACH_AR934x) || defined(CONFIG_MACH_QCA955x)
...
#define avm_gpio_init           ar7240_avm_gpio_init		/*--- init ar7240_avm_gpio_init(void) ---*/ 
#define avm_gpio_ctrl           ar7240_avm_gpio_ctrl		/*--- int ar7240_avm_gpio_ctrl(unsigned int gpio_pin, enum _hw_gpio_function pin_mode, enum _hw_gpio_direction pin_dir) ---*/
#define avm_gpio_out_bit        ar7240_avm_gpio_out_bit		/*--- int ar7240_avm_gpio_out_bit(unsigned int gpio_pin, int value)  ---*/
#define avm_gpio_in_bit         ar7240_avm_gpio_in_bit		/*--- int ar7240_avm_gpio_in_bit(unsigned int gpio_pin)  ---*/
#define avm_gpio_in_value       ar7240_avm_gpio_in_value	/*--- unsigned int ar7240_avm_gpio_in_value(void)  ---*/
#define avm_gpio_set_bitmask    ar7240_avm_gpio_set_bitmask	/*--- void ar7240_avm_gpio_set_bitmask(unsigned int mask, unsigned int value)  ---*/
#define avm_gpio_request_irq    ar7240_avm_gpio_request_irq
#define avm_gpio_enable_irq     ar7240_avm_gpio_enable_irq
#define avm_gpio_disable_irq    ar7240_avm_gpio_disable_irq
#endif /*--- #if defined(CONFIG_MACH_AR7240) ---*/ 

#if defined(CONFIG_MACH_AR724x) || defined(CONFIG_MACH_AR934x) || defined(CONFIG_MACH_QCA955x)
#include <atheros.h>
...
#endif /*--- #if defined(CONFIG_MACH_AR724x) || defined(CONFIG_MACH_AR934x) || defined(CONFIG_MACH_QCA955x) ---*/
