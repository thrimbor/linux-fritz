...
#define is_ar9344_1_0()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9344_REV_1_0)
#define is_ar9342_1_0()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9342_REV_1_0)
#define is_ar9341_1_0()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9341_REV_1_0)

#define is_ar9344_1_1()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9344_REV_1_1)
#define is_ar9342_1_1()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9342_REV_1_1)
#define is_ar9341_1_1()	((ar7240_reg_rd(AR7240_REV_ID) & AR7240_REV_ID_MASK) == AR9341_REV_1_1)

#define is_ar9344()	(is_ar9344_1_0() || is_ar9344_1_1())
#define is_ar9342()	(is_ar9342_1_0() || is_ar9342_1_1())
#define is_ar9341()	(is_ar9341_1_0() || is_ar9341_1_1())

#undef is_ar934x
#define is_ar934x()	(is_ar9344() || is_ar9342() || is_ar9341())
#define is_ar934x_1_0()	(is_ar9344_1_0() || is_ar9342_1_0() || is_ar9341_1_0())
#define is_ar934x_1_1()	(is_ar9344_1_1() || is_ar9342_1_1() || is_ar9341_1_1())
...
#define ar7240_flush_ge(_unit) do { \
	unsigned int reg = (_unit) ? AR7240_DDR_GE1_FLUSH : AR7240_DDR_GE0_FLUSH; \
	ar7240_reg_wr(reg, 1); \
...
int ar7240_local_read_config(int where, int size, unsigned int *value);
int ar7240_local_write_config(int where, int size, unsigned int value);
