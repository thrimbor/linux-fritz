...
#ifdef CONFIG_AR10
static void 
pcie_phy_36mhz_mode_ppm_setup(int pcie_port, int p0_ppm, int p1_ppm) 
{
    u16 sdm_val1;
    u16 sdm_val2;
...
pcie_phy_100mhz_mode_setup(int pcie_port) 
{
    ...
    /* mmd */
    IFX_PCIE_PHY_REG(PCIE_PHY_PLL_A_CTRL3(pcie_port), 0x8000, 0xe000);

    /* ref_clk_sel */
    IFX_PCIE_PHY_REG(PCIE_PHY_PLL_A_CTRL3(pcie_port), 0x0200, 0x0200);

    /* cp_sel: 010 */
    IFX_PCIE_PHY_REG(PCIE_PHY_PLL_A_CTRL1(pcie_port), 0x1000, 0x3800);    
...
#ifdef CONFIG_IFX_PCIE_PHY_36MHZ_MODE
#ifdef CONFIG_AR10
    pcie_phy_36mhz_mode_ppm_setup(pcie_port, 400, -400);
#else
