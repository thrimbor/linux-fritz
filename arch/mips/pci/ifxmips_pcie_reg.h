...
#define PCIE_MEM_PHY_PORT_TO_BASE(X)  (g_pcie_port_defs[(X)].port_to_addr.mem_phy_base) 
#define PCIE_MEM_PHY_PORT_TO_END(X)   (g_pcie_port_defs[(X)].port_to_addr.mem_phy_end) 
#define PCIE_IO_PHY_PORT_TO_BASE(X)   (g_pcie_port_defs[(X)].port_to_addr.io_phy_base) 
#define PCIE_IO_PHY_PORT_TO_END(X)    (g_pcie_port_defs[(X)].port_to_addr.io_phy_end) 
#define PCIE_APP_PORT_TO_BASE(X)      (g_pcie_port_defs[(X)].port_to_addr.app_logic_base) 
#define PCIE_RC_PORT_TO_BASE(X)       (g_pcie_port_defs[(X)].port_to_addr.rc_addr_base) 
#define PCIE_PHY_PORT_TO_BASE(X)      (g_pcie_port_defs[(X)].port_to_addr.phy_base) 
