...
#ifndef SERIAL_AVM_ASC_H
#define SERIAL_AVM_ASC_H
...
#define ASCFSTAT_RXFREEMASK             0x001F0000
#define ASCFSTAT_TXFREEMASK             0x1F000000
#define ASCFSTAT_TXFREEOFF              24
#endif
#ifdef CONFIG_AR10  /*--- kopie der VR9 Werte ---*/
#define ASCFSTAT_RXFFLMASK              0x001F
#define ASCFSTAT_TXFFLMASK              0x1F00
#define ASCFSTAT_TXFFLOFF               8
#define ASCFSTAT_RXFREEMASK             0x001F0000
...
typedef struct ifx_asc_port_priv {               /* ifx_asc_port_priv_t */
...
#include <vr9/vr9.h>
#define NR_UARTS	    	1
#define ASC_CONSOLE_UART	0

static ifx_asc_port_priv_t ifx_asc_port_priv[NR_UARTS] = {
    {
        .base      /* Port base address */   = (ifx_asc_reg_t*)IFX_ASC1,  
        .portwidth /* 8 or 32 */             = 8, 
        .tir       /* TX interrupt */        = IFX_ASC1_TIR, 
        .tbir      /* TX buffer interrupt */ = IFX_ASC1_TBIR, 
        .rir       /* RX interrupt */        = IFX_ASC1_RIR, 
        .eir       /* ERROR interrupt */     = IFX_ASC1_EIR, 
        .tx_irq_name                         = "asc1_tx", 
        .rx_irq_name                         = "asc1_rx", 
        .err_irq_name                        = "asc1_err", 
    }
};
...
#elif defined(CONFIG_AR9) /*--- #if defined(CONFIG_VR9) ---*/
#include <ar9/ar9.h>
#include <ifx_pmu.h>
#define NR_UARTS		    2
#define ASC_CONSOLE_UART	1
static ifx_asc_port_priv_t ifx_asc_port_priv[NR_UARTS] = {
    {
		base:(ifx_asc_reg_t*)IFX_ASC0, 
		portwidth:32, 
		tir:IFX_ASC0_TIR, 
		tbir:IFX_ASC0_TBIR, 
		rir:IFX_ASC0_RIR, 
		...
		tx_irq_name:"asc0_tx", 
		rx_irq_name:"asc0_rx", 
		err_irq_name:"asc0_err"
	},
    {
		base:(ifx_asc_reg_t*)IFX_ASC1, 
		portwidth: 8,
		tir:IFX_ASC1_TIR,
		tbir:IFX_ASC1_TBIR,
		rir:IFX_ASC1_RIR, 
