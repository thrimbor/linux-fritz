...
struct __attribute__ ((packed)) _capi_message {
    ...
    /*--- Offset 8 Bytes ---*/
            union __attribute__ ((packed)) _capi_message_part {
            struct __attribute__ ((packed)) _interoperability_request {
            unsigned short selector;
            unsigned char  interoperability_request_parameter_len;
#ifdef NOCH_NICHT /*--- short und int align für BLKFN ---*/
                struct __attribute__ ((packed)) _interoperability_request_parameter {
            ...
            struct __attribute__ ((packed)) _interoperability_conf {
            unsigned short Info;
            unsigned short selector;
...
#ifdef NOCH_NICHT /*--- short und int align für BLKFN ---*/
                struct __attribute__ ((packed)) _interoperability_conf_parameter {
                unsigned short function;
            ...
            struct __attribute__ ((packed)) _data_b3_req {
            unsigned int NCCI;
            unsigned char *Data;
            ...
            struct __attribute__ ((packed)) _data_b3_ind {
            unsigned int NCCI;
            unsigned char *Data;
            unsigned short DataLen;
            unsigned short Handle;
            ...
            struct __attribute__ ((packed)) _data_b3_conf {
            unsigned int NCCI;
            unsigned short Handle;
            unsigned short Info;
        } data_b3_conf;
            struct __attribute__ ((packed)) _data_b3_resp {
            unsigned int NCCI;
            unsigned short Handle;
        } data_b3_resp;
#ifdef NOCH_NICHT /*--- short und int align für BLKFN ---*/
            struct __attribute__ ((packed)) _alert_req {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } alert_req;
            struct __attribute__ ((packed)) _alert_conf {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } alert_conf;
            struct __attribute__ ((packed)) _connect_req {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } connect_req;
            struct __attribute__ ((packed)) _connect_conf {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } connect_conf;
            struct __attribute__ ((packed)) _connect_ind {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } connect_ind;
#endif /*--- #ifdef NOCH_NICHT ---*/
            struct __attribute__ ((packed)) _connect_resp {
            unsigned int PLCI;
            unsigned short reject;
            unsigned char params[1];
        } connect_resp;
            struct __attribute__ ((packed)) _connect_active_ind {
            unsigned int PLCI;
            unsigned char params[1];
        } connect_active_ind;
            struct __attribute__ ((packed)) _connect_active_resp {
            unsigned int PLCI;
        } connect_active_resp;
            struct __attribute__ ((packed)) _connect_b3_active_ind {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } connect_b3_active_ind;
            struct __attribute__ ((packed)) _connect_b3_active_resp {
            unsigned int NCCI;
        } connect_b3_active_resp;
            struct __attribute__ ((packed)) _connect_b3_req {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } connect_b3_req;
            struct __attribute__ ((packed)) _connect_b3_conf {
            unsigned int NCCI;
            unsigned short Info;
        } connect_b3_conf;
            struct __attribute__ ((packed)) _connect_b3_ind {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } connect_b3_ind;
            struct __attribute__ ((packed)) _connect_b3_resp {
            unsigned int NCCI;
            unsigned short reject;
            unsigned char NCPI[1];
        } connect_b3_resp;
            struct __attribute__ ((packed)) _connect_b3_t90_active_ind {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } connect_b3_t90_active_ind;
            struct __attribute__ ((packed)) _connect_b3_t90_active_resp {
            unsigned int NCCI;
        } connect_b3_t90_active_resp;
            struct __attribute__ ((packed)) _disconnect_b3_req {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } disconnect_b3_req;
            struct __attribute__ ((packed)) _disconnect_b3_conf {
            unsigned int NCCI;
            unsigned short Info;
        } disconnect_b3_conf;
            struct __attribute__ ((packed)) _disconnect_b3_ind {
            unsigned int NCCI;
            unsigned short reason;
            unsigned char NCPI[1];
        } disconnect_b3_ind;
            struct __attribute__ ((packed)) _disconnect_b3_resp {
            unsigned int NCCI;
        } disconnect_b3_resp;
            struct __attribute__ ((packed)) _disconnect_req {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } disconnect_req;
            struct __attribute__ ((packed)) _disconnect_conf {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } disconnect_conf;
            struct __attribute__ ((packed)) _disconnect_ind {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } disconnect_ind;
            struct __attribute__ ((packed)) _disconnect_resp {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } disconnect_resp;
            struct __attribute__ ((packed)) _facility_req {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } facility_req;
            struct __attribute__ ((packed)) _facility_conf {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } facility_conf;
            struct __attribute__ ((packed)) _facility_ind {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } facility_ind;
            struct __attribute__ ((packed)) _facility_resp {
            unsigned int kommt_noch; /*--- parameter noch einzugeben ---*/
        } facility_resp;
            struct __attribute__ ((packed)) _info_req {
            unsigned int controller;
            unsigned char params[1];
        } info_req;
            struct __attribute__ ((packed)) _info_conf {
            unsigned int controller;
            unsigned short Info;
        } info_conf;
            struct __attribute__ ((packed)) _info_ind {
            unsigned int controller;
            unsigned char params[1];
        } info_ind;
            struct __attribute__ ((packed)) _info_resp {
            unsigned int controller;
        } info_resp;
            struct __attribute__ ((packed)) _listen_req {
            unsigned int controller;
            ...
            struct __attribute__ ((packed)) _listen_conf {
            unsigned int controller;
            unsigned short Info;
        } listen_conf;
            struct __attribute__ ((packed)) _manufacturer_req {
            unsigned int controller;
            ...
            struct __attribute__ ((packed)) _manufacturer_conf {
            unsigned int controller;
            unsigned int manu_id;
            unsigned int Class;
            unsigned int function;
            ...
            struct __attribute__ ((packed)) _manufacturer_ind {
            unsigned int controller;
            unsigned int manu_id;
            unsigned int Class;
            unsigned int function;
            ...
            struct __attribute__ ((packed)) _manufacturer_resp {
            unsigned int controller;
            unsigned int manu_id;
            unsigned int Class;
            unsigned int function;
            ...
            struct __attribute__ ((packed)) _reset_b3_req {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } reset_b3_req;
            struct __attribute__ ((packed)) _reset_b3_conf {
            unsigned int NCCI;
            unsigned short Info;
        } reset_b3_conf;
            struct __attribute__ ((packed)) _reset_b3_ind {
            unsigned int NCCI;
            unsigned char NCPI[1];
        } reset_b3_ind;
            struct __attribute__ ((packed)) _reset_b3_resp {
            unsigned int NCCI;
        } reset_b3_resp;
            struct __attribute__ ((packed)) _select_b_protocol_req {
            unsigned int PLCI;
            unsigned char BProotcol[1];
        } select_b_protocol_req;
            struct __attribute__ ((packed)) _select_b_protocol_conf {
            unsigned int PLCI;
            unsigned short Info;
