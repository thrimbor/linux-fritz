...
IFX_return_t IFX_FLOW_MMD_MDIO_DataRead(IFX_void_t *pDevCtx, IFX_ETHSW_MDIO_data_t *pPar, IFX_uint8_t portIdx,IFX_uint8_t dev)
{
	IFX_FLOW_switchDev_t *pEthSWDevHandle = (IFX_FLOW_switchDev_t*)pDevCtx;
//	IFX_uint32_t cfg_reg;
	IFX_ETHSW_MDIO_data_t mmd_data;

	/* Check MDC_CFG_0.PEN_x */
	ifx_ethsw_ll_DirectAccessWrite(pDevCtx, (VR9_MDC_CFG_0_PEN_0_OFFSET + IFX_ETHSW_FLOW_TOP_REG_OFFSET),	\
		VR9_MDC_CFG_0_PEN_0_SHIFT, 6, 0); 
	udelay(1000);
	...
	ifx_ethsw_ll_DirectAccessWrite(pDevCtx, (VR9_MDC_CFG_0_PEN_0_OFFSET + IFX_ETHSW_FLOW_TOP_REG_OFFSET),	\
		VR9_MDC_CFG_0_PEN_0_SHIFT, 6, 0x3F);
	mmd_data.nAddressDev = pPar->nAddressDev;
	mmd_data.nAddressReg = 0xe;
...
IFX_return_t IFX_FLOW_MMD_MDIO_DataWrite(IFX_void_t *pDevCtx, IFX_ETHSW_MDIO_data_t *pPar,IFX_uint8_t portIdx,IFX_uint8_t dev)
{
//	IFX_uint32_t cfg_reg;
	IFX_ETHSW_MDIO_data_t mmd_data;
	IFX_FLOW_switchDev_t *pEthSWDevHandle = (IFX_FLOW_switchDev_t*)pDevCtx;
...
IFX_return_t IFX_FLOW_CPU_PortExtendCfgSet(IFX_void_t *pDevCtx, IFX_ETHSW_CPU_PortExtendCfg_t *pPar)
{
	...
	if ((pPar->bHeaderRemove == IFX_TRUE) && (pPar->eHeaderAdd != IFX_ETHSW_CPU_HEADER_NO)) {
