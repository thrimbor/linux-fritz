...
*****************************************************************************/
#ifndef _CPMAC_REG_H_
#define _CPMAC_REG_H_

#ifndef MEM_PTR
#define MEM_PTR volatile unsigned int *
#endif
...
#define  CPMAC_RX_FLOWTHRESH(base,ch)         (*(MEM_PTR)((base) + 0x120 + (4 * (ch))))
...
#define  CPMAC_RX_FREEBUFFER(base,ch)         (*(MEM_PTR)((base) + 0x140 + (4 * (ch))))
...
/* special ack value in case of teardown int */
#define TEARDOWN_ACK 0xfffffffc

/* cpmac mode flags */
#define CB_SOF_BIT         (1ul << 31)
#define CB_EOF_BIT         (1ul << 30)
#define CB_OWNERSHIP_BIT   (1ul << 29)
#define CB_EOQ_BIT         (1ul << 28)
