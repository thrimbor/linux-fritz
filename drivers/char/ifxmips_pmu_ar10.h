...
static ifx_pmu_t g_ifx_pmu = {
    ...
    .module        = {
                    ...
                    {IFX_PMU_MODULE_DCDC_2V5, 81, 0, "DCDc-2V5",     0}, /* always on */
                    {-1, -1, 0, "SDIO",     0},
                    {IFX_PMU_MODULE_UART1, IFX_PMU_MODULE_UART1, 0, "UART1",    0}, /* Keep console on */  
                    {IFX_PMU_MODULE_DCDC_1VX, 82, 0, "DCDC-1VX", 0}, /* always on */
                    {IFX_PMU_MODULE_DCDC_1V0, 83, 0, "DCDC-1V0", 0}, /* always on */
                    ...
                    {IFX_PMU_MODULE_PCIE1_CTRL, 49, 0, "PCIE1-CTRL",         1},
